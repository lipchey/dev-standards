...
> Статус 4.3: ВИКОНАНО 2026-07-14 — core 0c28e6e (G1/G2 у гайді), пілот
> 9ce4be8 (пін) + 3bfc88d (additive overlay), verify fast+full пілота
> зелені; acceptance «доктрина в заповненому гайді пілота» виконується
> читанням template in place на бампнутому піні + overlay. Фаза 4 закрита
> (4.1/4.2 — N2/N3, 4.4 лишається ПАРКОВАНИМ за власним тригером).
...
> Статус: ВИКОНАНО 2026-07-15 (тег **v0.17.0**, core `839e9fe`; v0.16.0 = чужий
> seed-parity батч, поверх якого цей ребейзнуто). Reality-sync цієї
...
>   існує й повний).
>
> _Нижче — ОРИГІНАЛЬНИЙ спец Фази 6 (збережений для провенансу); фактичний статус —
> у ноті вище. Приклад розбіжності: п.1 «ADR-008/012 retired» неточний — 008 retired,
> 012 active (workflow-імплементацію знято, рішення живе в deep-review), див. docs/ADR.md._
...
> Статус: ВИКОНАНО 2026-07-15 (хвости закриті разом із Фазою 6, тег v0.17.0, core `839e9fe`).
